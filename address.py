...
def address(full_name, apartment, street_number_int, street_name, city, province, postal_code, apartment_number = None):
    ...
    if apartment_number != None:
        address = full_name + "\n" + apartment_number + street_number_int + street_name + "\n" + city + province + "" + postal_code
    else:
        address = full_name + "\n" + street_number_int + street_name + city + province + "\n" + postal_code
...
def main():
    ...
    try:
        ...
        # call functions
        address_2 = address(full_name, apartment, street_number_int, street_name, city, province, postal_code, apartment_number)
